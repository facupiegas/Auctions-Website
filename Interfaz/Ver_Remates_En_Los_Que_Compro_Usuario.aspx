<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Ver_Remates_En_Los_Que_Compro_Usuario.aspx.cs" Inherits="Interfaz.Ver_Remates_En_Los_Que_Compro_Usuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
    <br />
    SLECCIONE UN REMATE</p>
<asp:GridView ID="grdRemates" runat="server" AutoGenerateSelectButton="True" OnSelectedIndexChanged="grdRemates_SelectedIndexChanged" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" style="text-align: center" Width="622px">
    ...
    <br />
<asp:GridView ID="grdLotesDisponiblesDeRemate" runat="server" Visible="False" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="191px" style="text-align: center; margin-right: 0px;">
    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
    <Columns>
